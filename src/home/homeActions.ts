...
export const HomeActions = {
  ...
  deleteDatabase: (id: string) =>
    createAction(HomeActionsTypes.DELETE_DATABASE, {id}),
  ...
  createDatabaseVersion: (databaseId: string) =>
    createAction(HomeActionsTypes.CREATE_DATABASE_VERSION, {databaseId}),
